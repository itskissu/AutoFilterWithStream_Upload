...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'helpkissu')
...
URL = "https://professorbot-qqd7.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://professorbot-qqd7.onrender.com".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://professorbot-qqd7.onrender.com/".format(FQDN)
else:
    URL = "https://professorbot-qqd7.onrender.com/".format(FQDN)
